...
# Input fields
weight = st.number_input("💪 Enter your weight (kg):", min_value=0.0, max_value=300.0, step=0.1, value=0.0)
height = st.number_input("📏 Enter your height (m):", min_value=0.0, max_value=3.0, step=0.01, value=0.0)
